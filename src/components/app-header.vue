<template>
  <header class="navbar navbar-expand navbar-dark flex-column flex-md-row bd-navbar">
    <a class="navbar-brand mr-0 mr-md-2" href="/" aria-label="Bootstrap">
      <img :src="require('../assets/logo-ico.svg')" width="36" height="36"  />           
    </a>
    ...
    <div class="navbar-nav-scroll">
      <ul class="navbar-nav bd-navbar-nav flex-row">
        ...
        <li class="nav-item">
          <router-link class="nav-link" to="/fundos">Fundo imobiliário</router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link" to="/cdb">CDB</router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link" to="/acoes">Ações</router-link>
        </li>
        <li class="nav-item">
